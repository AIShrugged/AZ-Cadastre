...
const en: Dict = {
  ...
  'page.register.subtitle':
    'Packages awaiting your decision. The system prepares the evidence — you decide.',
  ...
  'empty.filtered.body':
    'No packages in this segment. Clear the filter to see the full register.',
  ...
  // ── Profiles (policy) ──────────────────────────────────────────────────────
  'page.profiles.title': 'Verification profiles',
  'page.profiles.subtitle':
    'What a package is measured against: the documents each kind of submission must carry, and what the system reads off each of them.',
  'profiles.all': 'All profiles',
  'profiles.required_label': 'required',
  'profiles.required_docs': 'Required documents',
  'profiles.also_recognised': 'Also recognised',
  'profiles.fields': 'Fields read',
  'profiles.no_fields': 'Nothing is read off this document',
  'profiles.unknown': 'No profile is named {key}. Choose one from the list.',
  'profiles.engine':
    'Profiles are declared by the engine and change with a deployment — this surface reports them, it does not edit them.',
  'profiles.empty.title': 'No profiles published',
  'profiles.empty.body':
    'The engine names no verification profile, so there is nothing for a package to be measured against.',
  'profiles.error.title': 'Profiles could not be read',
  'profiles.error.body':
    'The engine did not answer. Reload the page to ask again.',
  // ── New verification (upload) ──────────────────────────────────────────────
  'page.new.title': 'New verification',
  'page.new.subtitle':
    'Add the submitted documents and start — the system reads and classifies each one.',
  'new.field.profile': 'Verification profile',
  'new.profile.docs': '{n} documents',
  'new.tip': 'Tip.',
  'new.tip.text':
    'Add documents in any order — the system recognizes each type, so you don’t have to sort them.',
...
const ru: Dict = {
  ...
  'page.register.subtitle':
    'Пакеты, ожидающие вашего решения. Система готовит доказательства — решаете вы.',
  ...
  'empty.filtered.body':
    'В этом сегменте нет пакетов. Сбросьте фильтр, чтобы увидеть весь реестр.',
  ...
  // ── Profiles (policy) ──────────────────────────────────────────────────────
  'page.profiles.title': 'Профили проверки',
  'page.profiles.subtitle':
    'С чем сверяется пакет: документы, которые должно нести обращение каждого вида, и то, что система читает с каждого из них.',
  'profiles.all': 'Все профили',
  'profiles.required_label': 'обязательных',
  'profiles.required_docs': 'Обязательные документы',
  'profiles.also_recognised': 'Также распознаётся',
  'profiles.fields': 'Извлекаемые поля',
  'profiles.no_fields': 'С этого документа ничего не извлекается',
  'profiles.unknown': 'Профиля {key} нет. Выберите профиль из списка.',
  'profiles.engine':
    'Профили объявлены в системе и меняются вместе с её обновлением — этот экран их показывает, но не редактирует.',
  'profiles.empty.title': 'Профилей нет',
  'profiles.empty.body':
    'Система не называет ни одного профиля проверки — значит, сверять пакет не с чем.',
  'profiles.error.title': 'Не удалось прочитать профили',
  'profiles.error.body':
    'Система не ответила. Обновите страницу, чтобы запросить снова.',
  // ── Новая проверка (загрузка) ──────────────────────────────────────────────
  'page.new.title': 'Новая проверка',
  'page.new.subtitle':
    'Добавьте поданные документы и запустите — система читает и классифицирует каждый.',
  'new.field.profile': 'Профиль проверки',
  'new.profile.docs': '{n} документов',
  'new.tip': 'Совет.',
  'new.tip.text':
    'Добавляйте документы в любом порядке — система сама распознаёт тип каждого, сортировать не нужно.',
...
const az: Dict = {
  ...
  'page.register.subtitle':
    'Qərarınızı gözləyən paketlər. Sistem sübutları hazırlayır — qərarı siz verirsiniz.',
  ...
  'empty.filtered.body':
    'Bu bölmədə paket yoxdur. Tam reyestri görmək üçün filtri təmizləyin.',
  ...
  // ── Profiles (policy) ──────────────────────────────────────────────────────
  'page.profiles.title': 'Yoxlama profilləri',
  'page.profiles.subtitle':
    'Paketin nə ilə tutuşdurulduğu: hər müraciət növünün daşımalı olduğu sənədlər və sistemin onların hər birindən nə oxuduğu.',
  'profiles.all': 'Bütün profillər',
  'profiles.required_label': 'mütləq',
  'profiles.required_docs': 'Mütləq sənədlər',
  'profiles.also_recognised': 'Həmçinin tanınır',
  'profiles.fields': 'Oxunan sahələr',
  'profiles.no_fields': 'Bu sənəddən heç nə oxunmur',
  'profiles.unknown': '{key} adlı profil yoxdur. Siyahıdan birini seçin.',
  'profiles.engine':
    'Profillər sistemdə elan olunur və onun yenilənməsi ilə dəyişir — bu ekran onları göstərir, redaktə etmir.',
  'profiles.empty.title': 'Profil dərc olunmayıb',
  'profiles.empty.body':
    'Sistem heç bir yoxlama profili adlandırmır, deməli paketi tutuşdurmağa bir şey yoxdur.',
  'profiles.error.title': 'Profillər oxunmadı',
  'profiles.error.body':
    'Sistem cavab vermədi. Yenidən soruşmaq üçün səhifəni yeniləyin.',
  // ── Yeni yoxlama (yükləmə) ──────────────────────────────────────────────────
  'page.new.title': 'Yeni yoxlama',
  'page.new.subtitle':
    'Təqdim olunan sənədləri əlavə edin və başladın — sistem hər birini oxuyur və təsnif edir.',
  'new.field.profile': 'Yoxlama profili',
  'new.profile.docs': '{n} sənəd',
  'new.tip': 'Məsləhət.',
  'new.tip.text':
    'Sənədləri istənilən ardıcıllıqla əlavə edin — sistem hər birinin tipini özü tanıyır, çeşidləməyə ehtiyac yoxdur.',
  ...
  'new.mapping_hint':
    'Hər tipə uyğun hesab etdiyiniz faylı əlavə edin. Sistem hər sənədi yenidən oxuyur və təsnif edir; sizin uyğunlaşdırmanız burada tamlığı müəyyən edir.',
