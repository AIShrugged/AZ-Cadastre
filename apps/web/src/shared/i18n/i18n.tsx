...
const en: Dict = {
  ...
  // A confirmation over an empty comparison is the misreading this block was
  // rebuilt to close (COMM-150). The archive answered, its copy stated not one
  // of the eight lines, every comparison was vacuous — and the block still
  // headed itself "National Archive copy agrees". Its own word and its own
  // sentence, and neither of them says the paper was borne out.
  'detail.qr.confirmed_no_line': 'Only the copy\u2019s signature was checked',
  'detail.qr.confirmed_no_line_note':
    'The National Archive answered, and its copy states none of the eight lines — so nothing written on the paper was held against it. The signature below verifies that this file is as the National Archive released it; it does not bear out what the paper says.',
  ...
  // Labels and no longer sentences with the value baked in: in a table the
  // label belongs in the label column, and the reading belongs beside it
  // (COMM-150).
  'detail.qr.signed_by': 'Copy signed by',
  'detail.qr.signed_on': 'Copy signed on',
  'detail.qr.cert_organisation': "Signer's certificate issued by",
  'detail.qr.cert_unit': "Signer's subdivision",
  'detail.qr.cert_validity': 'Certificate valid',
  // The row with no name of its own: whether the signature verified.
  'detail.qr.sig_valid': 'Signature',
  'detail.qr.reference': 'QR reference:',
  'detail.qr.no_reference': 'nothing was decoded',
  'detail.qr.checked_at': 'checked {when}',
  // The four column headings of the comparison table, and the two of the
  // signature table.
  'detail.qr.col_field': 'Field',
  'detail.qr.col_result': 'Result',
  'detail.qr.col_value': 'Value',
  'detail.qr.in_document': 'On the paper',
  'detail.qr.in_archive': "In the National Archive's copy",
  // The result column: five words, one per row, and never a sentence. The two
  // silences are told apart because they are different news — the fonds keeping
  // no such column, and this system declining to put the line (ADR-0040) — and
  // told as one the reader blames the archive for a rule of ours.
  'detail.qr.o_match': 'agrees',
  'detail.qr.o_mismatch': 'differs',
  ...
  'detail.qr.competence': 'Powers of the issuing body',
  ...
  'mine.one.phase': 'Step {k} of {n}',
  'mine.one.phase.1': 'Reading your documents',
  'mine.one.phase.2': 'Comparing them with each other',
  'mine.one.phase.3': 'Asking the archive',
  'mine.one.phase.4': 'Putting the result together',
  'mine.one.read_off': 'What your documents say',
  'mine.one.stated': 'What you stated when filing',
  'mine.one.kind': 'Kind of application',
  'mine.one.unsure': 'being confirmed',
  'mine.one.unread': 'Not read yet',
  'mine.one.unfound': 'Not found in your documents',
  'mine.one.unstated': 'Not stated',
  'mine.one.documents': 'Your documents',
  'mine.one.documents_reading':
    'Your files are still being read. Once they have been, this will say which documents are in and which are still wanted.',
  'mine.one.documents_unknown':
    'Which documents this application is checked against is not known yet.',
  'mine.one.checks': 'What has been checked',
  'mine.one.checks.papers': 'Your documents against each other',
  'mine.one.checks.archive': 'The archive record',
  'mine.one.checks.pending': 'Not reached yet',
  'mine.one.checks.empty': 'Nothing to compare',
  'mine.one.checks.ok': 'All agreed',
  'mine.one.checks.against': 'For the office to look at',
  'mine.one.checks.open': 'Not settled',
  'mine.one.checks.quiet': 'Nothing on record',
  'mine.one.archive.empty': 'The archive was not asked',
  'mine.one.archive.ok': 'Confirms your documents',
  'mine.one.archive.against': 'For the office to look at',
  'mine.one.archive.open': 'Not settled',
  'mine.one.archive.quiet': 'No record found',
  'mine.one.footnote':
...
const ru: Dict = {
  ...
  'detail.qr.confirmed_no_line': 'Сверена только подпись под копией',
  'detail.qr.confirmed_no_line_note':
    'Национальный архив ответил, но его копия не приводит ни одной из восьми строк — ничего из написанного в документе с ней не сверялось. Подпись ниже подтверждает, что файл получен от Национального архива в неизменном виде; сказанное в документе она не подтверждает.',
  ...
  'detail.qr.signed_by': 'Копию подписал',
  'detail.qr.signed_on': 'Дата подписания копии',
  'detail.qr.cert_organisation': 'Сертификат подписавшего выдан',
  'detail.qr.cert_unit': 'Подразделение подписавшего',
  'detail.qr.cert_validity': 'Срок действия сертификата',
  'detail.qr.sig_valid': 'Подпись',
  'detail.qr.reference': 'Ссылка QR-кода:',
  'detail.qr.no_reference': 'ничего не раскодировано',
  'detail.qr.checked_at': 'проверено {when}',
  'detail.qr.col_field': 'Поле',
  'detail.qr.col_result': 'Результат',
  'detail.qr.col_value': 'Значение',
  'detail.qr.in_document': 'В документе',
  'detail.qr.in_archive': 'В копии Национального архива',
  'detail.qr.o_match': 'совпало',
  'detail.qr.o_mismatch': 'не совпало',
  ...
  'mine.one.phase': 'Шаг {k} из {n}',
  'mine.one.phase.1': 'Читаем ваши документы',
  'mine.one.phase.2': 'Сверяем их между собой',
  'mine.one.phase.3': 'Запрашиваем архив',
  'mine.one.phase.4': 'Собираем результат',
  'mine.one.read_off': 'Что сказано в ваших документах',
  'mine.one.stated': 'Что вы указали при подаче',
  'mine.one.kind': 'Вид заявления',
  'mine.one.unsure': 'уточняется',
  'mine.one.unread': 'Ещё не прочитано',
  'mine.one.unfound': 'В ваших документах не найдено',
  'mine.one.unstated': 'Не указано',
  'mine.one.documents': 'Ваши документы',
  'mine.one.documents_reading':
    'Файлы ещё читаются. Когда прочитаются, здесь будет видно, какие документы на месте и каких не хватает.',
  'mine.one.documents_unknown':
    'Пока неизвестно, по какому перечню проверяется это заявление.',
  'mine.one.checks': 'Что уже проверено',
  'mine.one.checks.papers': 'Ваши документы между собой',
  'mine.one.checks.archive': 'Запись в архиве',
  'mine.one.checks.pending': 'Ещё не дошло',
  'mine.one.checks.empty': 'Сверять нечего',
  'mine.one.checks.ok': 'Всё сошлось',
  'mine.one.checks.against': 'Смотрит сотрудник',
  'mine.one.checks.open': 'Не решено',
  'mine.one.checks.quiet': 'Сведений нет',
  'mine.one.archive.empty': 'К архиву не обращались',
  'mine.one.archive.ok': 'Подтверждает ваши документы',
  'mine.one.archive.against': 'Смотрит сотрудник',
  'mine.one.archive.open': 'Не решено',
  'mine.one.archive.quiet': 'Запись не найдена',
  'mine.one.footnote':
...
const az: Dict = {
  ...
  'detail.qr.confirmed_no_line': 'Yalnız nüsxənin imzası yoxlanılıb',
  'detail.qr.confirmed_no_line_note':
    'Milli Arxiv cavab verdi, lakin onun nüsxəsi səkkiz sətirdən heç birini göstərmir — sənəddə yazılanların heç biri onunla tutuşdurulmayıb. Aşağıdakı imza faylın Milli Arxivdən verildiyi kimi qaldığını təsdiqləyir; sənəddə yazılanları təsdiqləmir.',
  ...
  'detail.qr.signed_by': 'Nüsxəni imzalayan',
  'detail.qr.signed_on': 'Nüsxənin imzalanma tarixi',
  'detail.qr.cert_organisation': 'İmzalayanın sertifikatını verən',
  'detail.qr.cert_unit': 'İmzalayanın struktur bölməsi',
  'detail.qr.cert_validity': 'Sertifikatın qüvvədə olma müddəti',
  'detail.qr.sig_valid': 'İmza',
  'detail.qr.reference': 'QR istinadı:',
  'detail.qr.no_reference': 'heç nə açılmayıb',
  'detail.qr.checked_at': 'yoxlanıb {when}',
  'detail.qr.col_field': 'Sahə',
  'detail.qr.col_result': 'Nəticə',
  'detail.qr.col_value': 'Dəyər',
  'detail.qr.in_document': 'Sənəddə',
  'detail.qr.in_archive': 'Milli Arxivin nüsxəsində',
  'detail.qr.o_match': 'uyğun gəldi',
  'detail.qr.o_mismatch': 'uyğun gəlmədi',
  ...
  'mine.one.phase': 'Addım {k} / {n}',
  'mine.one.phase.1': 'Sənədləriniz oxunur',
  'mine.one.phase.2': 'Bir-biri ilə tutuşdurulur',
  'mine.one.phase.3': 'Arxivə sorğu verilir',
  'mine.one.phase.4': 'Nəticə yığılır',
  'mine.one.read_off': 'Sənədlərinizdə nə yazılıb',
  'mine.one.stated': 'Müraciətdə nə göstərmisiniz',
  'mine.one.kind': 'Ərizə növü',
  'mine.one.unsure': 'dəqiqləşdirilir',
  'mine.one.unread': 'Hələ oxunmayıb',
  'mine.one.unfound': 'Sənədlərinizdə tapılmadı',
  'mine.one.unstated': 'Göstərilməyib',
  'mine.one.documents': 'Sənədləriniz',
  'mine.one.documents_reading':
    'Fayllarınız hələ oxunur. Oxunduqdan sonra burada hansı sənədlərin yerində olduğu və hansının çatışmadığı görünəcək.',
  'mine.one.documents_unknown':
    'Bu ərizənin hansı siyahı üzrə yoxlandığı hələ məlum deyil.',
  'mine.one.checks': 'Nə yoxlanılıb',
  'mine.one.checks.papers': 'Sənədləriniz bir-biri ilə',
  'mine.one.checks.archive': 'Arxiv qeydi',
  'mine.one.checks.pending': 'Hələ çatmayıb',
  'mine.one.checks.empty': 'Tutuşdurmağa bir şey yoxdur',
  'mine.one.checks.ok': 'Hamısı uyğun gəldi',
  'mine.one.checks.against': 'Əməkdaş baxır',
  'mine.one.checks.open': 'Həll olunmayıb',
  'mine.one.checks.quiet': 'Məlumat yoxdur',
  'mine.one.archive.empty': 'Arxivə sorğu verilməyib',
  'mine.one.archive.ok': 'Sənədlərinizi təsdiqləyir',
  'mine.one.archive.against': 'Əməkdaş baxır',
  'mine.one.archive.open': 'Həll olunmayıb',
  'mine.one.archive.quiet': 'Qeyd tapılmadı',
  'mine.one.footnote':
