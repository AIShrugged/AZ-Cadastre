...
const en: Dict = {
  ...
  "page.profiles.subtitle": "What a package is measured against: the documents each kind of submission must carry, and what the system reads off each of them.",
  ...
  "profiles.engine": "Profiles are declared by the engine and change with a deployment — this surface reports them, it does not edit them.",
  "profiles.empty.title": "No profiles published",
  "profiles.empty.body": "The engine names no verification profile, so there is nothing for a package to be measured against.",
  "profiles.error.title": "Profiles could not be read",
  "profiles.error.body": "The engine did not answer. Reload the page to ask again.",
...
const ru: Dict = {
  ...
  "page.profiles.subtitle": "С чем сверяется пакет: документы, которые должно нести обращение каждого вида, и то, что система читает с каждого из них.",
  ...
  "profiles.engine": "Профили объявлены в системе и меняются вместе с её обновлением — этот экран их показывает, но не редактирует.",
  "profiles.empty.title": "Профилей нет",
  "profiles.empty.body": "Система не называет ни одного профиля проверки — значит, сверять пакет не с чем.",
  "profiles.error.title": "Не удалось прочитать профили",
  "profiles.error.body": "Система не ответила. Обновите страницу, чтобы запросить снова.",
...
const az: Dict = {
  ...
  "page.profiles.subtitle": "Paketin nə ilə tutuşdurulduğu: hər müraciət növünün daşımalı olduğu sənədlər və sistemin onların hər birindən nə oxuduğu.",
  ...
  "profiles.engine": "Profillər sistemdə elan olunur və onun yenilənməsi ilə dəyişir — bu ekran onları göstərir, redaktə etmir.",
  "profiles.empty.title": "Profil dərc olunmayıb",
  "profiles.empty.body": "Sistem heç bir yoxlama profili adlandırmır, deməli paketi tutuşdurmağa bir şey yoxdur.",
  "profiles.error.title": "Profillər oxunmadı",
  "profiles.error.body": "Sistem cavab vermədi. Yenidən soruşmaq üçün səhifəni yeniləyin.",
