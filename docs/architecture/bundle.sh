#!/usr/bin/env sh
#
# Regenerate az-cadastre.c4 — the five source files as one document, which is
...
HEADER
  cat specification.c4 system.c4 erd-cadastre-db.c4 erd-cadastre-registry.c4 views.c4
} > az-cadastre.c4
