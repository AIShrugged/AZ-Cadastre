...
/**
 * The one refusal a sign-in has, for both of the ways it can fail: an address
 * no account answers to, and the wrong password against one that exists.
 *
 ...
 * half was wrong, not whether the address is known.
 */
