...
export function geometryInstructions(spec: DocumentTypeSpec): string {
  return [
    ...
    '',
    'All coordinates are fractions of the sheet you were shown: x is 0 at its',
    'left edge and 1 at its right edge, y is 0 at its top edge and 1 at its',
    'bottom edge. Give four decimal places. Never give a pixel.',
    '',
    'Return JSON, and only JSON:',
    '{"sheets":[{"sheet":<the sheet number>,',
